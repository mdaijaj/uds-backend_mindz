...
@Component({
  selector: 'app-courier-service-status',
  templateUrl: './courier-service-status.component.html',
  styleUrls: ['./courier-service-status.component.scss']
})
export class CourierServiceStatusComponent {
  assignAction: any;
  singleData: any = {};
  isChecked = false;
  checkBox: any;
  ...
  getValueToDisplay(params: ICellRendererParams) {
    ...
    return params.valueFormatted
      ...
      : params.data.courier_Service_id;
  }
  ...
  toggle(e: any, isChecked: boolean) {
    try {
      ...
      this._configurationalMasterService.updateCourierstatus(this.cellValue, body).subscribe((response: any) => {
        if (response) {
