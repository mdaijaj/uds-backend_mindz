...
@Component({
  selector: 'app-asset-category-status-action',
  templateUrl: './asset-category-status-action.component.html',
  styleUrls: ['./asset-category-status-action.component.scss']
})
export class AssetCategoryStatusActionComponent {
  ...
  toggle(e: any, isChecked: boolean) {
    try {
      ...
      this._configurationalMasterService.updateAssetMasterStatus(this.cellValue, body).subscribe((response: any) => {
        if (response) {
