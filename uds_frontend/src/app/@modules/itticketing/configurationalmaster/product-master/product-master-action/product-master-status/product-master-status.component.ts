...
@Component({
  selector: 'app-product-master-status',
  templateUrl: './product-master-status.component.html',
  styleUrls: ['./product-master-status.component.scss']
})
export class ProductMasterStatusComponent {
  assignAction: any;
  singleData: any = {};
  isChecked = false;
  checkBox: any;
