...
@Component({
  selector: 'app-courier-contain-status',
  templateUrl: './courier-contain-status.component.html',
  styleUrls: ['./courier-contain-status.component.scss']
})
export class CourierContainStatusComponent {
  assignAction: any;
  singleData: any = {};
  isChecked = false;
  checkBox: any;
  ...
  getValueToDisplay(params: ICellRendererParams) {
    ...
    return params.valueFormatted
      ...
      : params.data.courier_contains_id;
  }
  ...
  toggle(e: any, isChecked: boolean) {
    try {
      ...
      this._configurationalMasterService.updateContainsStatus(this.cellValue, body).subscribe((response: any) => {
        if (response) {
