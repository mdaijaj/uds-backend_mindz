...
@Component({
  selector: 'app-amc-discription-status',
  templateUrl: './amc-discription-status.component.html',
  styleUrls: ['./amc-discription-status.component.scss']
})
export class AmcDiscriptionStatusComponent {
  assignAction: any;
  singleData: any = {};
  isChecked = false;
  checkBox: any;
  ...
  getValueToDisplay(params: ICellRendererParams) {
    ...
    return params.valueFormatted
      ...
      : params.data.amc_description_id;
  }
  ...
  toggle(e: any, isChecked: boolean) {
    try {
      ...
      this._configurationalMasterService.updateAmcDesStatus(this.cellValue, body).subscribe((response: any) => {
        if (response) {
