    ...
    getAllPoList(){
      this.GrnService.getAllPoList().subscribe((response:any)=>{
         this.PoListData=response.data;
          this.PoListData.filter((res:any)=>{
          if(res.grn_masters[0].grnStatus=='PARTIAL'){
            this.partialListData.push(res)
          }
        })
           this.PoListData.filter((res:any)=>{
          if(res.grn_masters[0].grnStatus=='COMPLETE'){
            this.completedListData.push(res)
          }
        })
