...
@Component({
  selector: 'partially-allocated-form-action',
  templateUrl: './partially-allocated-form-action.component.html',
  styleUrls: ['./partially-allocated-form-action.component.scss']
})
export class PartiallyAllocatedFormActionComponent {
  assignAction: any;
  singleData: any = {};
  isChecked = false;
  checkBox: any;
