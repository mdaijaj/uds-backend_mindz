...
import { PartiallyAllocatedFormActionComponent } from './partially-allocated-form-action/partially-allocated-form-action.component';

@Component({
  selector: 'app-partially-allocated-form',
  templateUrl: './partially-allocated-form.component.html',
  styleUrls: ['./partially-allocated-form.component.css']
})
export class partiallyAllocatedFormComponent implements OnInit {
  rowClass: any;
  sales_order_no:any;
  ...
  public columnDefs = [
    ...
    },
    {
      ...
      cellClass: 'grid-cell-centered',
      flex: 1,
      cellRenderer: PartiallyAllocatedFormActionComponent,
      cellRendererParams: {
        className: 'mat-blue',
        hideRequestButton: true,
        hideDetailsButton: false,
