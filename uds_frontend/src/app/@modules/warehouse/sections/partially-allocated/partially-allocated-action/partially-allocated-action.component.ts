...
@Component({
  selector: 'partially-allocated-action',
  templateUrl: './partially-allocated-action.component.html',
  styleUrls: ['./partially-allocated-action.component.scss']
})
export class PartiallyAllocatedActionComponent {
  assignAction: any;
  singleData: any = {};
  isChecked = false;
  checkBox: any;
  ...
  redirect(){
    this.route.navigate(["master/warehouse-management/partially-allocated-form"]);
  }
