...
import { SalesOrderFormDialogComponent } from '../sales-order-form-dialog/sales-order-form-dialog.component';
@Component({
  selector: 'sales-order-form-action',
  templateUrl: './sales-order-form-action.component.html',
  styleUrls: ['./sales-order-form-action.component.scss']
})
export class SalesOrderFormActionComponent {
  assignAction: any;
  singleData: any = {};
  isChecked = false;
  checkBox: any;
