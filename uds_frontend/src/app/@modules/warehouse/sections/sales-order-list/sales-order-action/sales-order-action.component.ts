...
@Component({
  selector: 'sales-order-action',
  templateUrl: './sales-order-action.component.html',
  styleUrls: ['./sales-order-action.component.scss']
})
export class SalesOrderActionComponent {
  assignAction: any;
  singleData: any = {};
  isChecked = false;
  checkBox: any;
