...
@Component({
  selector: 'app-bay-row-text-field',
  templateUrl: './bay-row-text-field.component.html',
  styleUrls: ['./bay-row-text-field.component.scss']
})
export class BayRowTextFieldComponent {
