...
import { DoListFormActionComponent } from './do-list-form-action/do-list-form-action.component';

@Component({
  selector: 'app-do-list-form',
  templateUrl: './do-list-form.component.html',
  styleUrls: ['./do-list-form.component.css']
})
export class DoListFormComponent implements OnInit {
  rowClass: any;
  sales_order_no:any;
  ...
  public columnDefs = [
    ...
    },
    {
      ...
      cellClass: 'grid-cell-centered',
      flex: 1,
      cellRenderer: DoListFormActionComponent,
      cellRendererParams: {
        className: 'mat-blue',
        hideRequestButton: true,
        hideDetailsButton: false,
