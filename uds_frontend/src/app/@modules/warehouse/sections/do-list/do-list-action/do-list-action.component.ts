...
@Component({
  selector: 'do-list-action',
  templateUrl: './do-list-action.component.html',
  styleUrls: ['./do-list-action.component.scss']
})
export class DoListActionComponent {
  assignAction: any;
  singleData: any = {};
  isChecked = false;
  checkBox: any;
  ...
  redirect(){
    this.route.navigate(["master/warehouse-management/do-list-form"]);
  }
