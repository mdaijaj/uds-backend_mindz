...
@Component({
  selector: 'app-action-lead-form-setup-mandatory',
  templateUrl: './action-lead-form-setup-mandatory.component.html',
  styleUrls: ['./action-lead-form-setup-mandatory.component.scss']
})
export class ActionLeadFormSetupMandatoryComponent implements OnInit {
  assignAction: any;
  singleData: any = {};
  isChecked = false;
  checkBox: any;
  ...
  getValueToDisplay(params: ICellRendererParams) {
    this.checkBox = params.data.mandatory;
  ...
  toggle(e: any, isChecked: boolean) {
    try {
      ...
      e.stopPropagation();
      let mandatory;
      if (isChecked) mandatory = 'ACTIVE';
      else mandatory = 'INACTIVE';
