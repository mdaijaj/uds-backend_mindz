...
import { LmsApprovalDialogComponent } from '../lms-approval-dialog/lms-approval-dialog.component';

@Component({
  selector: 'app-procurement-budget-approval',
  templateUrl: './procurement-budget-approval.component.html',
  styleUrls: ['./procurement-budget-approval.component.scss']
})
export class ProcurementBudgetApprovalComponent {
  rowData: any;
