...
export class ActionComponent {
  ...
  {
    queryParams: { lead_genration_id: this.data.data.lead_genrate_id, br_number: this.data.data.br_number}
  }
);
}
...
this.toast.warning('Already Booked')
  ...
  const dialogRef = this.dialog.open(DialogAuditorAssignComponent,{minWidth:'500',
    data:{data,e}
  });
