...
@Component({
  selector: 'app-major-customer-reason-list',
  templateUrl: './major-customer-reason-list.component.html',
  styleUrls: ['./major-customer-reason-list.component.scss']
})
export class MajorCustomerReasonListComponent {
