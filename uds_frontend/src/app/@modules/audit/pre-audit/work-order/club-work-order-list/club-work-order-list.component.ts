...
@Component({
  selector: 'app-club-work-order-list',
  templateUrl: './club-work-order-list.component.html',
  styleUrls: ['./club-work-order-list.component.scss']
})
export class ClubWorkOrderListComponent {
