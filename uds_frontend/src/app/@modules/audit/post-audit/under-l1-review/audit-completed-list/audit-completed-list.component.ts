...
@Component({
  selector: 'app-audit-completed-list',
  templateUrl: './audit-completed-list.component.html',
  styleUrls: ['./audit-completed-list.component.scss']
})
export class AuditCompletedListComponent {
...
ngOnInit(): void {
  ...
  getAllData(){
    this.leadService.getApprovalTaskOrder().subscribe((res:any) => {
