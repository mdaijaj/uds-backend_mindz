...
@Component({
  selector: 'app-completeness-check-list',
  templateUrl: './completeness-check-list.component.html',
  styleUrls: ['./completeness-check-list.component.scss']
})
export class CompletenessCheckListComponent {
  ...
  ngOnInit(): void {
    ...
    getAllData(){
      this.leadService.getCompletnessCheck( this.mainId).subscribe((res:any) => {
