...
@Component({
  selector: 'app-techreview-audi-list',
  templateUrl: './techreview-audi-list.component.html',
  styleUrls: ['./techreview-audi-list.component.scss']
})
export class TechreviewAudiListComponent {
...
ngOnInit(): void {
  ...
  getAllData(){
    this.leadService.getAllTechnicalReview().subscribe((res:any) => {
