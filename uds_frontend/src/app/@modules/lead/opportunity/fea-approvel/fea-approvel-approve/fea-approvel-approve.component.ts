...
@Component({
  selector: 'app-fea-approvel-approve',
  templateUrl: './fea-approvel-approve.component.html',
  styleUrls: ['./fea-approvel-approve.component.scss']
})

  export class FeaApprovelApproveComponent {
  ...
  getAllSegment() {
    ...
    patchFormvalue() { 
      ...
      this.leadForm.patchValue({
        ...
        outstanding_amount: this.singleLeadData.outstanding_amount,
        tds_outstanding_amount: this.singleLeadData.tds_outstanding_amount,
