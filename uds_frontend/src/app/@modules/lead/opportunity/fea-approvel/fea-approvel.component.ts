...
@Component({
  selector: 'app-fea-approvel',
  templateUrl: './fea-approvel.component.html',
  styleUrls: ['./fea-approvel.component.scss']
})
  export class FeaApprovelComponent {
    ...
    constructor(private emp_master: EmpMasterService,
      ...
      this.activateRoute.queryParams.subscribe(
        (res: any) => {
          ...
          this.opportunityId = res.opportunityById
        }
      )
    ...
    ngOnInit(): void {
      ...
      this.leadService.getallFeaApprovelList().subscribe((res: any) => {
