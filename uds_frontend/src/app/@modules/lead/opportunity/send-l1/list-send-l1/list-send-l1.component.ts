...
@Component({
  selector: 'app-list-send-l1',
  templateUrl: './list-send-l1.component.html',
  styleUrls: ['./list-send-l1.component.scss']
})
export class ListSendL1Component {
...
this.Approver_id=res.employee_id 
        }
      )
  ...
  // this.leadService.getLeadSent().subscribe((res:any) => {
  //   
  //   this.rowData = res.result;
  // })  
  console.log(this.loginUserId,'this.loginUserId');

  this.leadService.getLeadSent(this.loginUserId).subscribe((res:any) => {
