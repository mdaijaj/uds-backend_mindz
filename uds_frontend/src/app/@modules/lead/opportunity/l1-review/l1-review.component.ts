...
@Component({
  selector: 'app-l1-review',
  templateUrl: './l1-review.component.html',
  styleUrls: ['./l1-review.component.scss']
})
export class L1ReviewComponent {
  ...
  this.leadService.getLeadPreL1New(this.mainId).subscribe((res:any) => {
