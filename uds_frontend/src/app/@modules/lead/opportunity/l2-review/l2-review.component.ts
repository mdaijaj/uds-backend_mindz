...
@Component({
  selector: 'app-l2-review',
  templateUrl: './l2-review.component.html',
  styleUrls: ['./l2-review.component.scss']
})
export class L2ReviewComponent {
  ...
  this.leadService.getLeadPreL2(this.mainId).subscribe((res:any) => {
