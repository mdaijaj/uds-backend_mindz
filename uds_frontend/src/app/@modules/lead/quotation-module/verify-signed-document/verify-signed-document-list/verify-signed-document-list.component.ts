...
@Component({
  selector: 'app-verify-signed-document-list',
  templateUrl: './verify-signed-document-list.component.html',
  styleUrls: ['./verify-signed-document-list.component.scss']
})
export class VerifiedSignedDocumentListComponent {
  ...
  this.leadService.snmHeadApproved().subscribe((res:any) => {
