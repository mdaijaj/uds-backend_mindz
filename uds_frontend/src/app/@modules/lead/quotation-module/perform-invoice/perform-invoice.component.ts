...
export class PerformInvoiceComponent {
  ...
  this.leadService.getPerform().subscribe((res:any) => {
  ...
  public columnDefs = [
    ...
    // },
    {
      ...
      cellStyle: function (params: any) {
        if (params.value.toLowerCase() == 'Perform Invoice Sent'.toLowerCase()) {
          return { color: 'green' };
        }else if (params.value.toLowerCase() == 'S&M Approved'.toLowerCase()) {
          return { color: 'blue' };
        }else {
          return { color: 'orange' };
        }
