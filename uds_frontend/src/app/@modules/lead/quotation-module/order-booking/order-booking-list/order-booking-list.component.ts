...
@Component({
  selector: 'app-order-booking-list',
  templateUrl: './order-booking-list.component.html',
  styleUrls: ['./order-booking-list.component.scss']
})
export class OrderBookingListComponent {
  ...
  this.leadService.getOrder().subscribe((res:any) => {
  ...
  onCellClicked(e:any){
    ...
    const dialogRef = this.dialog.open(OrderBookingCreateComponent,{width:'650px',data:{lead_id:e.data.lead_genration_id}});
