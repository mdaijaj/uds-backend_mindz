...
@Component({
  selector: 'app-signed-document-list',
  templateUrl: './signed-document-list.component.html',
  styleUrls: ['./signed-document-list.component.scss']
})
export class SignedDocumentListComponent {
...
console.log(id);
  ...
  this.leadService.getSignedDocNew(this.mainId).subscribe((res:any) => {
