...
@Component({
  selector: 'app-send-quote-list',
  templateUrl: './send-quote-list.component.html',
  styleUrls: ['./send-quote-list.component.scss']
})
export class SendQuoteListComponent {
  ...
  this.leadService.getQuotationSent(this.mainId).subscribe((res:any) => {
    ...
    // },
    {
      ...
      cellStyle: function (params: any) {
        if (params.value.toLowerCase() == 'Open'.toLowerCase()) {
          ...
          return { color: 'red' };
        }else if (params.value.toLowerCase() == 'Quotation Sent'.toLowerCase()) {
          return { color: 'blue' };
        } else {
          return { color: 'orange' };
        }
