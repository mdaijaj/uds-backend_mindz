...
@Component({
  selector: 'app-snm-head-approver-list',
  templateUrl: './snm-head-approver-list.component.html',
  styleUrls: ['./snm-head-approver-list.component.scss']
})
export class SnMHeadListComponent {
