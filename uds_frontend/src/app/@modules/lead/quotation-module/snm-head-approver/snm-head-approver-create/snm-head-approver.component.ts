...
@Component({
  selector: 'app-snm-head-approver',
  templateUrl: './snm-head-approver.component.html',
  styleUrls: ['./snm-head-approver.component.scss']
})
export class SnMHeadNewComponent {
...
this.logoCost=true;
  ...
  submitQAForm() {
    ...
    this.leadService.editLead(this.lead_id, this.dataMain).subscribe((res:any) => {
      ...
      //
      this.toast.success("Documents Approved Successfully..")
      this.route.navigate(['master/lead/quotation'],
        { queryParams: { lead_id: this.lead_id } }
      );
    })
