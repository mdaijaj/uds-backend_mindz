...
@Component({
  selector: 'app-send-for-sm-list',
  templateUrl: './send-for-s&m-list.component.html',
  styleUrls: ['./send-for-s&m-list.component.scss']
})
export class SendForSMListComponent {
  ...
  // this.leadService.getApprovedOne().subscribe((res:any) => {
    
  //   this.rowData = res.result;
  // })  
  this.mainId = localStorage.getItem("EmpMainId");

  this.leadService.getAllSMapprovelNew(this.mainId).subscribe((res:any) => {
