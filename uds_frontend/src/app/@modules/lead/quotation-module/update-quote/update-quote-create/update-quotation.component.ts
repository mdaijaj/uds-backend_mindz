...
this.logoCost=true;
  ...
  getStage(br1: any) {
    this.leadService.getStage(br1).subscribe((res: any) => {
      ...
      console.log(this.stageData,"stageData one");
  ...
  getStage1(br1: any) {
    this.leadService.getStage(br1).subscribe((res: any) => {
      this.stageData = res.data;
      console.log(this.stageData,"stageData two");
...
console.log(this.br2,"br");
  ...
  raiseWorkOrder() {
    ...
    if(this.singleLeadData?.budgetaryQuote == 'TRUE'){
      ...
      leadStatus = "Digitally Signed Document"
    }
      const dataNew = {
        customer_type: val.customer_type,
        // site_audit: val.site_audit || " ",
