...
@Component({
  selector: 'app-digitally-signed-document-list',
  templateUrl: './digitally-signed-document-list.component.html',
  styleUrls: ['./digitally-signed-document-list.component.scss']
})
export class DigitallySignedDocumentListComponent {
  ...
  this.leadService.getDigitalSignedDoc().subscribe((res:any) => {
