...
@Component({
  selector: 'app-update-quote-list',
  templateUrl: './update-quote-list.component.html',
  styleUrls: ['./update-quote-list.component.scss']
})
export class UpdateQuoteListComponent {
  ...
  this.leadService.getPOReceived().subscribe((res:any) => {
  ...
  onCellClicked(e:any){
    ...
    this.route.navigate(['master/lead/lead-opportunity/customer-account'],
        { queryParams: { lead_id:e.data.lead_genration_id } }
      ); 
    // const dialogRef = this.dialog.open(CustomerAccountComponent,{width:'500px',data:{opportunity_id:e.data.lead_genration_id}});
