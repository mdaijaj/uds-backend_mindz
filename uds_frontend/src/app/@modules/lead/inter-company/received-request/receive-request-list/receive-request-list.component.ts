...
@Component({
  selector: 'app-receive-request-list',
  templateUrl: './receive-request-list.component.html',
  styleUrls: ['./receive-request-list.component.scss']
})
export class ReceiveRequestListComponent {
  ...
  this.leadService.getInterCompanyListRecieved().subscribe((res:any) => {
