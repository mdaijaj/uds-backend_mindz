...
@Component({
  selector: 'app-list-validate',
  templateUrl: './list-validate.component.html',
  styleUrls: ['./list-validate.component.scss']
})
export class ValidateListComponent {
  ...
  this.leadService.getLeadValidate().subscribe((res:any) => {
