...
@Component({
  selector: 'app-opportunity-exist-cust',
  templateUrl: './opportunity-exist-cust.component.html',
  styleUrls: ['./opportunity-exist-cust.component.scss']
})
export class OpportunityExistCustComponent {
