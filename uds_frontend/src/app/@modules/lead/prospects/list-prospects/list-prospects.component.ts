...
export class ListProspectsComponent {
  ...
  this.leadService.getLeadProspect(this.mainId).subscribe((res:any) => {
    console.log(res,'res lead prospect');
    
    this.rowData = res.result;
    console.log('dffd', res.result);
    
  })  
  this.rowData="No Record Found"
