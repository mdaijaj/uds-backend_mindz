...
@Component({
  selector: 'app-ra-tra-list90',
  templateUrl: './ra-tra-list90.component.html',
  styleUrls: ['./ra-tra-list90.component.scss']
})
export class RATRALIST90Component 
{
  ...
  ngOnInit(): void {
    ...
    this.leadService.getVerifiedDqsData().subscribe((res:any)=>{
      ...
      let modifyData=(res.result).filter((modi:any)=>modi.notification_status=="MSA Head & CSP");
