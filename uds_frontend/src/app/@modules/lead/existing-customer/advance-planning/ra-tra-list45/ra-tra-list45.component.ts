...
@Component({
  selector: 'app-ra-tra-list45',
  templateUrl: './ra-tra-list45.component.html',
  styleUrls: ['./ra-tra-list45.component.scss']
})
export class RATRALIST45Component 

{
  ...
  ngOnInit(): void {
    this.leadService.getVerifiedDqsData().subscribe((res:any)=>{
      let modifyData=(res.result).filter((modi:any)=>modi.notification_status=="MD & CSP");
