...
@Component({
  selector: 'app-ra-tra-list120',
  templateUrl: './ra-tra-list120.component.html',
  styleUrls: ['./ra-tra-list120.component.scss']
})
export class RATRALIST120Component 

{
  ...
  ngOnInit(): void {
    this.leadService.getVerifiedDqsData().subscribe((res:any)=>{
      let modifyData=(res.result).filter((modi:any)=>modi.notification_status=="RBH & CSP");
