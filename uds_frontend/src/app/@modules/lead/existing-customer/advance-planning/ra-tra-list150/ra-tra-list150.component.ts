...
@Component({
  selector: 'app-ra-tra-list150',
  templateUrl: './ra-tra-list150.component.html',
  styleUrls: ['./ra-tra-list150.component.scss']
})
export class RATRALIST150Component 
{
  ...
  ngOnInit(): void {
    ...
    this.leadService.getVerifiedDqsData().subscribe((res:any)=>{
      ...
      let modifyData=(res.result).filter((modi:any)=>modi.notification_status=="SP & CSP");
