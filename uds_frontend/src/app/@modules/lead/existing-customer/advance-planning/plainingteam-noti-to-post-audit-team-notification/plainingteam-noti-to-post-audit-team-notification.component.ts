...
@Component({
  selector: 'app-plainingteam-noti-to-post-audit-team-notification',
  templateUrl: './plainingteam-noti-to-post-audit-team-notification.component.html',
  styleUrls: ['./plainingteam-noti-to-post-audit-team-notification.component.scss']
})
export class PlainingteamNotiToPostAuditTeamNotificationComponent 

{
  ...
  ngOnInit(): void {
    ...
    this.leadService.getVerifiedDqsData().subscribe((res: any) => {
      ...
      let modifyData = (res.result).filter((modi: any) => modi.remaining_count ==0 || modi.RA_TRA_LIST=="UPDATED");
  ...
  navigate(){
    this.router.navigate(['master/lead/existing-customer/advance-planning/RA-TRA180']);
