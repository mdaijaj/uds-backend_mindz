...
@Component({
  selector: 'app-auditor-invoice-pdf',
  templateUrl: './auditor-invoice-pdf.component.html',
  styleUrls: ['./auditor-invoice-pdf.component.scss']
})
export class AuditorInvoicePdfComponent {
  leadId: any;
  singleLeadData: any;
  idZogo: string | null;
  invoiceData: any;
