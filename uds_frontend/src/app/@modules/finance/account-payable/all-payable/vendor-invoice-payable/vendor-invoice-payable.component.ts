...
@Component({
  selector: 'app-vendor-invoice-payable',
  templateUrl: './vendor-invoice-payable.component.html',
  styleUrls: ['./vendor-invoice-payable.component.scss']
})
export class VendorInvoicePayableComponent {
