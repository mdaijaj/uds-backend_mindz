...
@Component({
  selector: 'app-reject-invoice-list',
  templateUrl: './reject-invoice-list.component.html',
  styleUrls: ['./reject-invoice-list.component.scss']
})
export class RejectInvoiceListComponent {
