...
@Component({
  selector: 'app-action-approved',
  templateUrl: './action-approved.component.html',
  styleUrls: ['./action-approved.component.scss']
})
export class ActionApprovedComponent {
  ...
  getValueToDisplay(params: ICellRendererParams) {
    ...
    console.log('2323',this.Manual_Invoice_id);
  ...
  sendZohoInvoice(e: any) {
    ...
    this.route.navigate(
      ...
      { queryParams: { id: this.Manual_Invoice_id, br_number: this.brNumberApproved } }
    );
  }
