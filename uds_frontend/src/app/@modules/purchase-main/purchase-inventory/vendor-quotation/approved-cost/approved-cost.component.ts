...
import { RejectedActionComponent } from '../rejected/rejected-action/rejected-action.component';

@Component({
  selector: 'app-approved-cost',
  templateUrl: './approved-cost.component.html',
  styleUrls: ['./approved-cost.component.scss']
})
export class ApprovedCostComponent {
  rowClass: any;
  ...
  getAllapprovedCost() {
    this.prService.getAllapprovedCost().subscribe((res: any) => {
