...
@Component({
  selector: 'app-po-issued',
  templateUrl: './po-issued.component.html',
  styleUrls: ['./po-issued.component.scss']
})
export class PoIssuedComponent {
  rowClass: any;
  ...
  public columnDefs = [
    ...
    },
    {
      ...
      flex: 1,
      minWidth: 150,
      cellRenderer: PoIssuedActionComponent,
      cellRendererParams: {
        className: 'mat-blue',
  ...
  getAllIssuedPOData() {
    this.prService.getAlltobeIssuedPO(this.employee_id).subscribe((res: any) => {
