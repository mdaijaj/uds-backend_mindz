...
@Component({
  selector: 'app-hk-security-agreement',
  templateUrl: './hk-security-agreement.component.html',
  styleUrls: ['./hk-security-agreement.component.scss']
})
export class HkSecurityAgreementComponent {
  subModules: any;
  subM: any;
