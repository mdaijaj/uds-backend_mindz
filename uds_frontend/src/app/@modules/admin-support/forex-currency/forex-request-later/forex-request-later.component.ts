...
@Component({
  selector: 'app-forex-request-later',
  templateUrl: './forex-request-later.component.html',
  styleUrls: ['./forex-request-later.component.scss']
})
export class ForexRequestLaterComponent {
  getPDFdata: boolean;
  singleData: any;
  id: any;
