...
@Component({
  selector: 'app-forex-action',
  templateUrl: './forex-action.component.html',
  styleUrls: ['./forex-action.component.scss']
})
export class ForexActionComponent {
  id: any;
  ...
  edit(e:any) {
    e.stopPropagation();
    // 
    this.route.navigate(['/master/admin-support/forex-currency/forex_currency_approval'], { queryParams: { id: this.cellValue } })
  }
