...
@Component({
  selector: 'app-remote-office-facility',
  templateUrl: './remote-office-facility.component.html',
  styleUrls: ['./remote-office-facility.component.scss']
})
export class RemoteOfficeFacilityComponent {
  subModules: any;
  subM: any;
