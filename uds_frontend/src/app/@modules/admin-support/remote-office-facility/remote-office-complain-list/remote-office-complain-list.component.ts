...
@Component({
  selector: 'app-remote-office-complain-list',
  templateUrl: './remote-office-complain-list.component.html',
  styleUrls: ['./remote-office-complain-list.component.scss']
})
export class RemoteOfficeComplainListComponent {
  rowClass: any;
  public status =[
    {id:1, name:'Banglore'},
    {id:2, name:'New Delhi'},
  ...
  onFilterTextBoxChanged1(e:any) {
   ...
   getUnAppVendor(){
     this.adminService.getAllComplain().subscribe((res:any)=>{
