module.exports = app => {
    ...
    app.get("/api/v1/getEmployeesByRoleId/:role_id", role_masterController.getEmployeesByRoleId);
    app.get("/api/v1/getByBranchIdroleMaster/:branch_id", role_masterController.getByBranchIdroleMaster);
    app.get("/api/v1/getRoleMasterByBranchId/:branch_id", role_masterController.getRoleMasterByBranchId);
